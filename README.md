...
**版本：v1.2.0** · **作者：青山 / Q1lintu / c0ffee（核心开发者）** · © 2026 ToShell
...
ToShell是一个基于 Go 语言的自托管 C2 框架。它由 **Team Server**（服务端 + Web 控制台）、**Implant**（植入端）与 **CLI 工具** 三部分组成，覆盖从载荷生成、会话管理到任务执行的完整攻击链路：
